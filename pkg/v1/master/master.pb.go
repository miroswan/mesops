...
// source: github.com/miroswan/mesops/pkg/v1/master/master.proto

/*
Package master is a generated protocol buffer package.

It is generated from these files:
	github.com/miroswan/mesops/pkg/v1/master/master.proto
...
import maintenance "github.com/miroswan/mesops/pkg/v1/maintenance"
import quota "github.com/miroswan/mesops/pkg/v1/quota"
...
type Call struct {
	Type                      *Call_Type                      `protobuf:"varint,1,opt,name=type,enum=master.Call_Type" json:"type,omitempty"`
...
type Call_ReserveResources struct {
	SlaveId          *mesos.SlaveID    `protobuf:"bytes,1,req,name=slave_id,json=slaveId" json:"slave_id,omitempty"`
...
type Response struct {
	Type                   *Response_Type                   `protobuf:"varint,1,opt,name=type,enum=master.Response_Type" json:"type,omitempty"`
...
type Response_GetAgents struct {
	...
	RecoveredAgents  []*mesos.SlaveInfo `protobuf:"bytes,2,rep,name=recovered_agents,json=recoveredAgents" json:"recovered_agents,omitempty"`
	XXX_unrecognized []byte             `json:"-"`
}
...
type Response_GetAgents_Agent struct {
	AgentInfo        *mesos.SlaveInfo `protobuf:"bytes,1,req,name=agent_info,json=agentInfo" json:"agent_info,omitempty"`
...
type Response_GetExecutors_Executor struct {
	...
	SlaveId          *mesos.SlaveID      `protobuf:"bytes,2,req,name=slave_id,json=slaveId" json:"slave_id,omitempty"`
	XXX_unrecognized []byte              `json:"-"`
}
...
type Response_GetTasks struct {
	...
	UnreachableTasks []*mesos.Task `protobuf:"bytes,5,rep,name=unreachable_tasks,json=unreachableTasks" json:"unreachable_tasks,omitempty"`
...
type Event struct {
	Type             *Event_Type             `protobuf:"varint,1,opt,name=type,enum=master.Event_Type" json:"type,omitempty"`
...
type Event_AgentRemoved struct {
	AgentId          *mesos.SlaveID `protobuf:"bytes,1,req,name=agent_id,json=agentId" json:"agent_id,omitempty"`
	XXX_unrecognized []byte         `json:"-"`
}
...
func init() {
	proto.RegisterType((*Call)(nil), "master.Call")
	proto.RegisterType((*Call_GetMetrics)(nil), "master.Call.GetMetrics")
	proto.RegisterType((*Call_SetLoggingLevel)(nil), "master.Call.SetLoggingLevel")
	proto.RegisterType((*Call_ListFiles)(nil), "master.Call.ListFiles")
	proto.RegisterType((*Call_ReadFile)(nil), "master.Call.ReadFile")
	proto.RegisterType((*Call_UpdateWeights)(nil), "master.Call.UpdateWeights")
	proto.RegisterType((*Call_ReserveResources)(nil), "master.Call.ReserveResources")
	proto.RegisterType((*Call_UnreserveResources)(nil), "master.Call.UnreserveResources")
	proto.RegisterType((*Call_CreateVolumes)(nil), "master.Call.CreateVolumes")
	proto.RegisterType((*Call_DestroyVolumes)(nil), "master.Call.DestroyVolumes")
	proto.RegisterType((*Call_UpdateMaintenanceSchedule)(nil), "master.Call.UpdateMaintenanceSchedule")
	proto.RegisterType((*Call_StartMaintenance)(nil), "master.Call.StartMaintenance")
	proto.RegisterType((*Call_StopMaintenance)(nil), "master.Call.StopMaintenance")
	proto.RegisterType((*Call_SetQuota)(nil), "master.Call.SetQuota")
	proto.RegisterType((*Call_RemoveQuota)(nil), "master.Call.RemoveQuota")
	proto.RegisterType((*Response)(nil), "master.Response")
	proto.RegisterType((*Response_GetHealth)(nil), "master.Response.GetHealth")
	proto.RegisterType((*Response_GetFlags)(nil), "master.Response.GetFlags")
	proto.RegisterType((*Response_GetVersion)(nil), "master.Response.GetVersion")
	proto.RegisterType((*Response_GetMetrics)(nil), "master.Response.GetMetrics")
	proto.RegisterType((*Response_GetLoggingLevel)(nil), "master.Response.GetLoggingLevel")
	proto.RegisterType((*Response_ListFiles)(nil), "master.Response.ListFiles")
	proto.RegisterType((*Response_ReadFile)(nil), "master.Response.ReadFile")
	proto.RegisterType((*Response_GetState)(nil), "master.Response.GetState")
	proto.RegisterType((*Response_GetAgents)(nil), "master.Response.GetAgents")
	proto.RegisterType((*Response_GetAgents_Agent)(nil), "master.Response.GetAgents.Agent")
	proto.RegisterType((*Response_GetFrameworks)(nil), "master.Response.GetFrameworks")
	proto.RegisterType((*Response_GetFrameworks_Framework)(nil), "master.Response.GetFrameworks.Framework")
	proto.RegisterType((*Response_GetExecutors)(nil), "master.Response.GetExecutors")
	proto.RegisterType((*Response_GetExecutors_Executor)(nil), "master.Response.GetExecutors.Executor")
	proto.RegisterType((*Response_GetTasks)(nil), "master.Response.GetTasks")
	proto.RegisterType((*Response_GetRoles)(nil), "master.Response.GetRoles")
	proto.RegisterType((*Response_GetWeights)(nil), "master.Response.GetWeights")
	proto.RegisterType((*Response_GetMaster)(nil), "master.Response.GetMaster")
	proto.RegisterType((*Response_GetMaintenanceStatus)(nil), "master.Response.GetMaintenanceStatus")
	proto.RegisterType((*Response_GetMaintenanceSchedule)(nil), "master.Response.GetMaintenanceSchedule")
	proto.RegisterType((*Response_GetQuota)(nil), "master.Response.GetQuota")
	proto.RegisterType((*Event)(nil), "master.Event")
	proto.RegisterType((*Event_Subscribed)(nil), "master.Event.Subscribed")
	proto.RegisterType((*Event_TaskAdded)(nil), "master.Event.TaskAdded")
	proto.RegisterType((*Event_TaskUpdated)(nil), "master.Event.TaskUpdated")
	proto.RegisterType((*Event_FrameworkAdded)(nil), "master.Event.FrameworkAdded")
	proto.RegisterType((*Event_FrameworkUpdated)(nil), "master.Event.FrameworkUpdated")
	proto.RegisterType((*Event_FrameworkRemoved)(nil), "master.Event.FrameworkRemoved")
	proto.RegisterType((*Event_AgentAdded)(nil), "master.Event.AgentAdded")
	proto.RegisterType((*Event_AgentRemoved)(nil), "master.Event.AgentRemoved")
	proto.RegisterEnum("master.Call_Type", Call_Type_name, Call_Type_value)
	proto.RegisterEnum("master.Response_Type", Response_Type_name, Response_Type_value)
	proto.RegisterEnum("master.Event_Type", Event_Type_name, Event_Type_value)
}

func init() {
	proto.RegisterFile("github.com/miroswan/mesops/pkg/v1/master/master.proto", fileDescriptor0)
}
...
var fileDescriptor0 = []byte{
	...
	,
}
